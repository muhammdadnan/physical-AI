...
const config: Config = {
  ...
  tagline: 'Building AI Native Applications',
  ...
  url: 'https://ai-native-book-sable.vercel.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/muhammdadnan/ai-native-book/tree/main/packages/create-docusaurus/templates/shared/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/muhammdadnan/ai-native-book',
          label: 'GitHub',
          position: 'right',
        },
      ],
